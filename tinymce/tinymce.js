		...
		editor.addButton( 'simple_button', {
			...
			menu: [
				...
				},
				{
					text: 'Accordions',
					onclick: function() {
						editor.insertContent("[accordion][panel title='Title' state='closed']Place your text here.[/panel][panel title='Title' state='open']Place your text here.[/panel][/accordion]");
					}
				},
				{
					text: 'Toggles',
				...
				},
				{
					...
					onclick: function() {
						editor.windowManager.open( {
								...
								},
								{
									...
									onclick: function() {
										...
										window.mb.frame.on('insert', function() {
											...
											jQuery('#my-image-box').val(json.id);
										});
							...
							onsubmit: function( e ) {
								editor.insertContent( '[random_shortcode textbox="' + e.data.textboxName + '" image="' + e.data.image + '" listbox="' + e.data.listboxName + '"]');
							}
						});
					}
				}
